...
import gymmanagement.network.Client;
        ...
        if (user.getText().isEmpty() || pass.getText().isEmpty()) {
            ...
            try {
                ...
                if (AdminLogin.isSelected()) {
                    boolean status = Client.getInstance().adminLogin(new Admin(username, password));
                    if (status) {
                    ...
                    boolean status = Client.getInstance().trainerLogin(new gymmanagement.model.Trainer(username, password));
                    if (status) {
